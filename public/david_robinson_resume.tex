...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \educationItem{\textbf{Relevant Coursework}: Computer Vision, Data Structures and Algorithms I \& II, Software Engineering, Linear Algebra}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Led research toward publication in \textbf{ICCV 2025}, focusing on 3D hand and body pose estimation}
        \resumeItem{Engineered an algorithm for stroke patient movement analysis using \textbf{Meta AI's Sapiens Pose and Depth} models to predict and lift 2D keypoints for 3D pose estimation.}
      \resumeItemListEnd
    \resumeSubheading
