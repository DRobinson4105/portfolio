...
\section{Open Source Contributions}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\href{https://github.com/ModelingValueGroup/dclareForMPS}{\textbf{\uline{DclareForMPS}}} $|$ \emph{Java, JUnit, Jetbrains MPS}}{}
        \resumeItemListStart
          \resumeItem{Designed and implemented a graph-based ordering system to store imperative transactions, using depth-first search and parallel computing to optimize execution efficiency.}
