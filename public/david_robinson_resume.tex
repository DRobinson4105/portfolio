...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Created a custom dataset of \textbf{1,036} video samples of stroke patients performing Box and Block Tests, segmenting videos into 30-frame clips for temporal action classification.}
  ...
  \resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Constructed an LSTM-based model to interpolate 2D keypoints for smoother ASL sign transitions.}
      \resumeItemListEnd
    \resumeProjectHeading
