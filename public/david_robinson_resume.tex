  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Implemented an algorithm for stroke patient movement analysis using the \textbf{Meta AI's Sapiens Pose and Depth} models for \textbf{3D pose estimation}, as part of an R21-funded research project.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Engineered a \textbf{Truffle-based interpreter} running on GraalVM, achieving a \textbf{500\% performance} boost by integrating \textbf{JMH benchmarking}.}
      \resumeItemListEnd
