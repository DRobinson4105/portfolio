...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Created a dataset of \textbf{1,036} video clips of stroke patients performing Box and Block Tests for movement analysis using pose estimation and action classification.}
